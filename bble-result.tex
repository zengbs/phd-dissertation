...
\section{Morphology and properties of Galactic bubbles}
 ...
 \begin{figure}%
      ...
      \begin{subfigure}[b]{0.2\linewidth}%
         \includegraphics[height=10cm]{bble-figures/fig__jetI5+ismSeed3-45deg-a}%
         \caption{}%
         \label{fig__jetI5+ismSeed3-45deg-a}%
      \end{subfigure}%
      \hspace{10pt}%
      \begin{subfigure}[b]{0.2\linewidth}%
         \includegraphics[height=10cm]{bble-figures/fig__jetI5+ismSeed3-45deg-b}%
         \caption{}%
         \label{fig__jetI5+ismSeed3-45deg-b}%
      \end{subfigure}%
      \hspace{-2pt}%
      \begin{subfigure}[b]{0.2\linewidth}%
         \includegraphics[height=10cm]{bble-figures/fig__jetI5+ismSeed3-45deg-c}%
         \caption{}%
         \label{fig__jetI5+ismSeed3-45deg-c}%
      \end{subfigure}%
      \hspace{-2pt}%
      \begin{subfigure}[b]{0.2\linewidth}%
         \includegraphics[height=10cm]{bble-figures/fig__jetI5+ismSeed3-45deg-d}%
         \caption{}%
 ...
 \begin{figure}%
      \begin{subfigure}[t]{0.5\linewidth}%
         \includegraphics[height=8cm]{bble-figures/fig__profile-1.png}%
         \label{fig__profile-1}%
      \end{subfigure}%
      \hspace{4pt}
      \begin{subfigure}[t]{0.5\linewidth}%
         \includegraphics[height=8cm]{bble-figures/fig__profile-2.png}%
...
% 2. North Polar Spur is not shown as it is a supernova remanent near us.
 ...
 \begin{figure*}%
      \begin{subfigure}[t]{\textwidth}%
         \centering%
         \includegraphics[width=0.85\textwidth]{bble-figures/fig__xraymap.png}%
         \caption{
      ...
      \begin{subfigure}[t]{\textwidth}%
         \centering%
         \includegraphics[width=0.85\textwidth]{bble-figures/fig__xray-profile-0.8keV-000.png}%
         \caption{
